# 🏢 WeLive
- 위리브는 **입주민과 아파트 관리 단체를 위한 상호 관리 플랫폼**입니다.

아파트 운영은 단순히 공지사항을 전달하는 수준을 넘어 입주민 명부 관리, 민원 처리, 주민 투표 등 다양한 관리 업무가 동시에 이루어져야 합니다.
위리브는 이러한 불편함을 해결하기 위해 **아파트 관리의 모든 기능을 하나의 플랫폼 제공하는 올인원 시스템입니다.**
**Team. SECURITY**  
---
